...
export default function EditMovie() {
  ...
  useEffect(() => {
    API.get(`/movies/${id}`)
      ...
      .catch(() => setError("Failed to load movie details. Please go back and try again."))
    ...
    return (
      <div className="min-h-screen bg-[#0f1117] flex items-center justify-center px-4">
        ...
        <div className="w-full max-w-xl space-y-4 animate-pulse">
          <div className="h-[3px] w-full rounded-t-2xl bg-white/10" />
          <div className="bg-[#161b27] border border-white/[0.07] rounded-b-2xl px-8 py-10 space-y-5">
      ...
      <div className="relative w-full max-w-xl mx-auto">
        ...
        <div className="bg-[#161b27] border border-white/[0.07] rounded-b-2xl shadow-2xl shadow-black/50 px-8 py-10">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-xl font-bold text-white" style={{ fontFamily: "'Sora', sans-serif" }}>Edit Movie</h1>
              <p className="text-sm text-slate-400">Update the details in your vault</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="group">
              ...
              <div className="bg-[#1e2535] border border-white/[0.08] rounded-xl px-3 py-2.5 transition-all duration-200 hover:border-white/[0.14] focus-within:border-indigo-500/60 focus-within:ring-1 focus-within:ring-indigo-500/30">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={loading || isRatingInvalid || success}
